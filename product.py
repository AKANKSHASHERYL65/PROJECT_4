...
df = pd.read_csv("C:\\Users\\ASM\\Downloads\\Reviews.csv")
print(df.columns)
print(df.shape)
...
ProductReviewSummary.to_csv("C:\\Users\\ASM\\Downloads\\ProductReviewSummary.csv")

dfProductReview

df3 = pd.read_csv("C:\\Users\\ASM\\Downloads\\ProductReviewSummary.csv")
...
dfReviews.to_csv("C:\\Users\\ASM\\Downloads\dfReviews.csv")
...
for i in range(lentest):
    ...
    print("Based on product reviews, for ", df3["ProductId"][lentrain + i], " average rating is ",
          df3["Score"][lentrain + i])
    print("The first similar product is ", df3["ProductId"][first_related_product], " average rating is ",
          df3["Score"][first_related_product])
    print("The second similar product is ", df3["ProductId"][second_related_product], " average rating is ",
          df3["Score"][second_related_product])
    print("-----------------------------------------------------------")
